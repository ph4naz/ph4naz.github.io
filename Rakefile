...
# #     tags = site.posts.collect do |post|
# #       post.tags
# #     end.flatten.uniq!
...
# #         <a href="http://ph4naz.github.io/tags/{{ tags }}.html" title="View posts tagged with &quot;{{ tags }}&quot;">{{ tags }}</a>{% if forloop.last != true %}, {% endif %}
# #         {% endfor %}
# #       </span>
# #     </div>
# #   </div>
...
# # </ul>
# # END
# #       File.open("tags/#{tags}.html", "w") do |f|
